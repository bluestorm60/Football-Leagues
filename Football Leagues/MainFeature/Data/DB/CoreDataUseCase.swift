...
//
//    // MARK: - Teams Handling
//    func saveTeams(_ teams: [TeamsUIModel.TeamUIModel], competition: CompetitionModel, completion: @escaping (CoreDataError?) -> Void) {
//        manager.persistentContainer.performBackgroundTask { context in
//            do {
...
//                }
//
//                try self.saveTeamsToContext(teams, for: competition, in: context)
//
//                // Save the changes
//                try context.save()
//
//                // Call the completion handler with no error to indicate success
//                completion(nil)
//            } catch {
...
//                guard let teamSet = competition.teams as? Set<Team> else {
...
//                continuation.resume(returning: .success(teamUIModels))
//            } catch {
//                // Call the completion handler with the error
...
//    }
//
//    func retrieveTeams(for competitionCode: String, completion: @escaping ([TeamsUIModel.TeamUIModel]?, CoreDataError?) -> Void) {
//        manager.persistentContainer.performBackgroundTask { context in
//            do {
//                guard let competition = try self.findCompetition(with: competitionCode, in: context) else {
//                    completion(nil, .competitionNotFound)
//                    return
//                }
//
//                // Check if the competition has associated teams
...
//
//                // Call the completion handler with the retrieved team UI models
//                completion(teamUIModels, nil)
//            } catch {
//                // Call the completion handler with the error
//                completion(nil, .competitionNotFoundWith(error))
//            }
//        }
//    }
//
...
//                }
//
//                // Delete existing teams for the competition
//                try self.deleteTeams(for: competition, context: context)
//
//                // Save the changes
//                try context.save()
//
...
//    }
//
//    private func saveTeamsToContext(_ teams: [TeamsUIModel.TeamUIModel], for competition: LeaguesUIModel.CompetitionUIModel, in context: NSManagedObjectContext) throws {
